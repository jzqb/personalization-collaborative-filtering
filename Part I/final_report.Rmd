...
The results indicate that user-based collaborative filtering with cosine similarity performs best on the jester dataset. SVD performs better than item-based approaches and random. For the item-based approaches, Pearson correlation outperforms cosine similarity. Let's now use cross-validation to tune the hyperparameter for each of these models.
