...
## @knitr fsvd_results
rmse_all <- c('k=5'= fsvd_model_5_result[[3]],'k=10'= fsvd_model_10_result[[3]],'k=20'= fsvd_model_20_result[[3]],'k=30'= fsvd_model_30_result[[3]],'k=40'= fsvd_model_40_result[[3]])
rmse_all

## @knitr ignore-3
### Get full rating matrix
fsvd_full_rating_matrix <- rbind(fsvd_model_10_result[[2]],fsvd_model_10_result[[5]])
fsvd_full_score_matrix <- rbind(fsvd_model_10_result[[1]],fsvd_model_10_result[[4]])
